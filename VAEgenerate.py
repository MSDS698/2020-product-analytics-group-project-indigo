...
trio_models['hierdec_trio_16bar'] = TrainedModel(hierdec_trio_16bar_config, 
...
trio_models['baseline_flat_trio_16bar'] = TrainedModel(flat_trio_16bar_config, 
...
mm.midi_io.note_sequence_to_midi_file(trio_16bar_mean, '%s_mean.mid' % trio_interp_model)
print('file wrote')